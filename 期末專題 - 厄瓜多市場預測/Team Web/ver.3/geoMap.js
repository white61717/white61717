function initialGeoMap(){
    ...
    var logaxis = d3.svg.axis().scale(logscale).orient("left").tickValues([0,1000000,10000000,100000000,200000000,300000000])   //.innerTickSize(-400)
        ...
        d3.json("map.topojson", function(error, toporoot) {         //讀topojson
            ...
            paths.on("mouseover",function(d,i){
                ...
                bar.data(saledata.provinces[stateNum].sale)
                    ...
                    .attr("y",function(d,i){
                        return 246 - logscale(d.unit_sales)
                    })
                    .attr("width",30)
